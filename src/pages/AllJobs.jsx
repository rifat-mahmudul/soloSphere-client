...
const AllJobs = () => {
    ...
    return (
        ...
        <div className='flex justify-center mt-12'>
            ...
            <button onClick={() => handlePagination(currentPage + 1)} disabled={currentPage === numberOfPages} className='px-4 py-2 mx-1 text-gray-700 transition-colors duration-300 transform bg-gray-200 rounded-md hover:bg-blue-500 disabled:hover:bg-gray-200 disabled:hover:text-gray-500 hover:text-white disabled:cursor-not-allowed disabled:text-gray-500'>
            <div className='flex items-center -mx-1'>
